...
namespace bibliotecaCrud.Controllers
{
    public class AutorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,Nome,Nacionalidade")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Nome,Nacionalidade")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
